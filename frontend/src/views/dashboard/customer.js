...
import yadu from '../../assets/img/yadu.jpg'
import ned from '../../assets/img/ned.jpg'
                ...
                <div className="row" data-aos="zoom-in" data-aos-delay="100">
                    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div className="member">
                            <img style={{ height: '400px', width: 'auto' }} src={abhi} className="img-fluid" alt="" />
                    ...
                    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div className="member">
                            <img style={{ height: '400px', width: '250px' }} src={ned} className="img-fluid" alt="" />
                            <div className="member-content">
                                <h4>Nedhiya Sunny</h4>
                                <span>Expert</span>
                                <p>
                    ...
                    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div className="member">
                            <img style={{ height: '400px', width: 'auto' }} src={srj} className="img-fluid" alt="" />
                            <div className="member-content">
                                <h4>Sooraj Varrma</h4>
                                <span>Expert</span>
                                <p>
                    ...
                    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div className="member">
                            <img style={{ height: '400px', width: '270px' }} src={yadu} className="img-fluid" alt="" />
                            <div className="member-content">
                                <h4>Yadu Krishna</h4>
                                <span>Expert</span>
                                <p>
